...
DataTypes.postgres = require('./dialects/postgres/data-types');
DataTypes.mysql = require('./dialects/mysql/data-types');
DataTypes.sqlite = require('./dialects/sqlite/data-types');
DataTypes.mssql = require('./dialects/mssql/data-types');
