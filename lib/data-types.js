...
ABSTRACT.prototype.stringify = function stringify(value, options) {
  const dialect = dialects[options.dialect || 'abstract'];
  return dialect[this.constructor.name].prototype.stringify.call(this, value, options);
};
ABSTRACT.parse = function parse(value, options) {
  const dialect = dialects[options.dialect || 'abstract'];
  return dialect[this.constructor.name].parse.call(this, value, options);
};
ABSTRACT.toSql = function toSql(value, options) {
  const dialect = dialects[options.dialect || 'abstract'];
  return dialect[this.constructor.name].toSql.call(this, value, options);
};
...
dialects.postgres = require('./dialects/postgres/data-types');
dialects.mysql = require('./dialects/mysql/data-types');
dialects.sqlite = require('./dialects/sqlite/data-types');
dialects.mssql = require('./dialects/mssql/data-types');
